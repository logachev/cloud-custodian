...
|           | `smtp_server`   | string           | if this is unset, aws ses or azure sendgrid is used by default. To configure your lambda role to talk to smtpd in your private vpc, see [here](https://docs.aws.amazon.com/lambda/latest/dg/vpc.html) |
